...
<div class="container-fluid pt-4 px-4">
    <div class="col-12">
        <div class="bg-white rounded h-100 p-4">
            <h1 class="mb-4 text-dark">Create New Pemasukan</h1>
            <hr class="dropdown-divider" style=" height: 3px">
            <div class="col-lg-8">
                <form method="post" action="/dashboard/tablepemasukan">
                    @csrf
                    ...
                    <button type="submit" class="btn btn-primary">Create Pemasukan</button>
                </form>
            </div>
        </div>
